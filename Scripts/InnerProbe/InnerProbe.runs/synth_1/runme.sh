...
HD_PWD='d:/vivado/ZCU104/InnerProbe/Scripts/InnerProbe/InnerProbe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InnerProbe_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InnerProbe_top.tcl
