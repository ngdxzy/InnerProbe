...
HD_PWD='d:/vivado/ZCU104/InnerProbe/Scripts/InnerProbe/InnerProbe.runs/InnerProbe_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InnerProbe_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InnerProbe_xbar_0.tcl
