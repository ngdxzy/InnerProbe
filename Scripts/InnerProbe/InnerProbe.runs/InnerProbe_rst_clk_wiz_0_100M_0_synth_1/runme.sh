...
HD_PWD='d:/vivado/ZCU104/InnerProbe/Scripts/InnerProbe/InnerProbe.runs/InnerProbe_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InnerProbe_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InnerProbe_rst_clk_wiz_0_100M_0.tcl
