...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ InnerProbe_AXI_DELAY_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Core is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Core;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Core is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMP_Core is
  port (
    signal_out : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMP_Core;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMP_Core is
...
inst_IDELAY3_DRP_lead: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IDELAY3_DRP
     port map (
      E(0) => E(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_DELAY is
  port (
    signal_out : out STD_LOGIC;
    S_AXI_DELAY_arready : out STD_LOGIC;
    S_AXI_DELAY_awready : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_DELAY;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_DELAY is
...
begin
inst_AXI_Core: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_Core
     port map (
...
inst_IMP_Core: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMP_Core
     port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "InnerProbe_AXI_DELAY_0_0,AXI_DELAY,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "AXI_DELAY,Vivado 2019.1";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AXI_DELAY
     port map (
      IDELAYCTRL_RST => IDELAYCTRL_RST,
      REFCLK => REFCLK,
      REFCLK_RESET_N => REFCLK_RESET_N,
