...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AVER_TIME" -parent ${Page_0}
...
proc update_PARAM_VALUE.AVER_TIME { PARAM_VALUE.AVER_TIME } {
	# Procedure called to update AVER_TIME when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AVER_TIME { PARAM_VALUE.AVER_TIME } {
	# Procedure called to validate AVER_TIME
	return true
}
...
proc update_MODELPARAM_VALUE.AVER_TIME { MODELPARAM_VALUE.AVER_TIME PARAM_VALUE.AVER_TIME } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AVER_TIME}] ${MODELPARAM_VALUE.AVER_TIME}
}
