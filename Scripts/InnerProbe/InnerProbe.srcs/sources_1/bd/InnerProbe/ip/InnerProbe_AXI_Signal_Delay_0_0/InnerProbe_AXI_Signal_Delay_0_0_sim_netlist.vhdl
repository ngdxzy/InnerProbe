...
--               d:/vivado/ZCU104/InnerProbe/Scripts/InnerProbe/InnerProbe.srcs/sources_1/bd/InnerProbe/ip/InnerProbe_AXI_Signal_Delay_0_0/InnerProbe_AXI_Signal_Delay_0_0_sim_netlist.vhdl
...
entity InnerProbe_AXI_Signal_Delay_0_0_AXI2NATIVE is
  port (
    ...
    S_AXI_SIGDELAY_rdata : out STD_LOGIC_VECTOR ( 8 downto 0 );
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \NATIVE_DATA_IN_reg[8]_0\ : out STD_LOGIC_VECTOR ( 8 downto 0 );
    ...
    S_AXI_SIGDELAY_wdata : in STD_LOGIC_VECTOR ( 8 downto 0 );
    S_AXI_SIGDELAY_araddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_SIGDELAY_arvalid : in STD_LOGIC;
    S_AXI_SIGDELAY_awaddr : in STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_SIGDELAY_wvalid : in STD_LOGIC;
    S_AXI_SIGDELAY_awvalid : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of InnerProbe_AXI_Signal_Delay_0_0_AXI2NATIVE : entity is "AXI2NATIVE";
end InnerProbe_AXI_Signal_Delay_0_0_AXI2NATIVE;

architecture STRUCTURE of InnerProbe_AXI_Signal_Delay_0_0_AXI2NATIVE is
  signal NATIVE_DATA_IN0 : STD_LOGIC;
  signal NATIVE_EN_i_1_n_0 : STD_LOGIC;
  signal \^native_wr\ : STD_LOGIC;
  signal \^s_axi_sigdelay_arready\ : STD_LOGIC;
  signal \^s_axi_sigdelay_awready\ : STD_LOGIC;
  signal \^s_axi_sigdelay_bvalid\ : STD_LOGIC;
  signal \^s_axi_sigdelay_rvalid\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity InnerProbe_AXI_Signal_Delay_0_0_IDELAY3_DRP is
  port (
    ...
    \signal_out[0]\ : in STD_LOGIC_VECTOR ( 8 downto 0 );
    E : in STD_LOGIC_VECTOR ( 0 to 0 );
    \S_AXI_rdata_reg[0]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
    start : in STD_LOGIC;
    wr : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of InnerProbe_AXI_Signal_Delay_0_0_IDELAY3_DRP : entity is "IDELAY3_DRP";
end InnerProbe_AXI_Signal_Delay_0_0_IDELAY3_DRP;

architecture STRUCTURE of InnerProbe_AXI_Signal_Delay_0_0_IDELAY3_DRP is
  signal \FSM_sequential_state[2]_i_1_n_0\ : STD_LOGIC;
  signal \FSM_sequential_state[2]_i_3_n_0\ : STD_LOGIC;
  signal \FSM_sequential_state[2]_i_4_n_0\ : STD_LOGIC;
  signal IDELAYE3_Master_i_2_n_0 : STD_LOGIC;
  signal \change__0\ : STD_LOGIC;
  ...
  signal NLW_IDELAYE3_Master_CASC_OUT_UNCONNECTED : STD_LOGIC;
  signal NLW_IDELAYE3_Master_CASC_RETURN_UNCONNECTED : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of IDELAYE3_Master_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of NATIVE_READY_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \S_AXI_rdata[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \S_AXI_rdata[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \S_AXI_rdata[2]_i_1\ : label is "soft_lutpair8";
...
IDELAYE3_Master: unisim.vcomponents.IDELAYE3
    generic map(
      ...
      CNTVALUEIN(8 downto 0) => \signal_out[0]\(8 downto 0),
      CNTVALUEOUT(8 downto 0) => delaytmp(8 downto 0),
      DATAIN => signal_in(0),
      DATAOUT => signal_out(0),
      EN_VTC => en_vtc,
      IDATAIN => '0',
      INC => '0',
...
IDELAYE3_Master_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
...
NATIVE_READY_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity InnerProbe_AXI_Signal_Delay_0_0_IDELAY_Core is
  port (
    signal_out : out STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    \data_in_reg[8]_0\ : in STD_LOGIC_VECTOR ( 8 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of InnerProbe_AXI_Signal_Delay_0_0_IDELAY_Core : entity is "IDELAY_Core";
end InnerProbe_AXI_Signal_Delay_0_0_IDELAY_Core;

architecture STRUCTURE of InnerProbe_AXI_Signal_Delay_0_0_IDELAY_Core is
  ...
  signal \addr_reg[-_n_0_1]\ : STD_LOGIC;
  signal \addr_reg_n_0_[0]\ : STD_LOGIC;
  signal data_in : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal \genblk4[0].inst_IDELAY3_DRP_lead_n_1\ : STD_LOGIC;
...
S_AXI_SIGDELAY_wready_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity InnerProbe_AXI_Signal_Delay_0_0_AXI_Signal_Delay is
  port (
    signal_out : out STD_LOGIC_VECTOR ( 0 to 0 );
    S_AXI_SIGDELAY_arready : out STD_LOGIC;
    S_AXI_SIGDELAY_awready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of InnerProbe_AXI_Signal_Delay_0_0_AXI_Signal_Delay : entity is "AXI_Signal_Delay";
end InnerProbe_AXI_Signal_Delay_0_0_AXI_Signal_Delay;

architecture STRUCTURE of InnerProbe_AXI_Signal_Delay_0_0_AXI_Signal_Delay is
  ...
  signal NATIVE_READY : STD_LOGIC;
  signal NATIVE_WR : STD_LOGIC;
  signal inst_AXI2NATIVE_n_15 : STD_LOGIC;
  signal inst_AXI2NATIVE_n_16 : STD_LOGIC;
begin
inst_AXI2NATIVE: entity work.InnerProbe_AXI_Signal_Delay_0_0_AXI2NATIVE
     port map (
      D(8 downto 0) => NATIVE_DATA_OUT(8 downto 0),
      E(0) => NATIVE_EN,
      \NATIVE_DATA_IN_reg[8]_0\(8 downto 0) => NATIVE_DATA_IN(8 downto 0),
      NATIVE_READY => NATIVE_READY,
      NATIVE_WR => NATIVE_WR,
      Q(1) => inst_AXI2NATIVE_n_15,
      Q(0) => inst_AXI2NATIVE_n_16,
      S_AXI_SIGDELAY_aclk => S_AXI_SIGDELAY_aclk,
      S_AXI_SIGDELAY_araddr(1 downto 0) => S_AXI_SIGDELAY_araddr(1 downto 0),
      S_AXI_SIGDELAY_aresetn => S_AXI_SIGDELAY_aresetn,
      S_AXI_SIGDELAY_arready => S_AXI_SIGDELAY_arready,
      S_AXI_SIGDELAY_arvalid => S_AXI_SIGDELAY_arvalid,
      S_AXI_SIGDELAY_awaddr(1 downto 0) => S_AXI_SIGDELAY_awaddr(1 downto 0),
      S_AXI_SIGDELAY_awready => S_AXI_SIGDELAY_awready,
      S_AXI_SIGDELAY_awvalid => S_AXI_SIGDELAY_awvalid,
      S_AXI_SIGDELAY_bready => S_AXI_SIGDELAY_bready,
      S_AXI_SIGDELAY_bvalid => S_AXI_SIGDELAY_bvalid,
      S_AXI_SIGDELAY_rdata(8 downto 0) => S_AXI_SIGDELAY_rdata(8 downto 0),
      S_AXI_SIGDELAY_rready => S_AXI_SIGDELAY_rready,
      S_AXI_SIGDELAY_rvalid => S_AXI_SIGDELAY_rvalid,
      S_AXI_SIGDELAY_wdata(8 downto 0) => S_AXI_SIGDELAY_wdata(8 downto 0),
      S_AXI_SIGDELAY_wvalid => S_AXI_SIGDELAY_wvalid
    );
inst_IDELAY_Core: entity work.InnerProbe_AXI_Signal_Delay_0_0_IDELAY_Core
     port map (
      D(1) => inst_AXI2NATIVE_n_15,
      D(0) => inst_AXI2NATIVE_n_16,
      E(0) => NATIVE_EN,
      ...
      \data_in_reg[8]_0\(8 downto 0) => NATIVE_DATA_IN(8 downto 0),
...
entity InnerProbe_AXI_Signal_Delay_0_0 is
  ...
  attribute NotValidForBitStream of InnerProbe_AXI_Signal_Delay_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of InnerProbe_AXI_Signal_Delay_0_0 : entity is "InnerProbe_AXI_Signal_Delay_0_0,AXI_Signal_Delay,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of InnerProbe_AXI_Signal_Delay_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of InnerProbe_AXI_Signal_Delay_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of InnerProbe_AXI_Signal_Delay_0_0 : entity is "AXI_Signal_Delay,Vivado 2019.1";
end InnerProbe_AXI_Signal_Delay_0_0;

architecture STRUCTURE of InnerProbe_AXI_Signal_Delay_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \^s_axi_sigdelay_rdata\ : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of REFCLK : signal is "XIL_INTERFACENAME REFCLK, ASSOCIATED_RESET rst_n:IDELAYCTRL_RST, PHASE 0.0, CLK_DOMAIN InnerProbe_clk_wiz_0_0_system_clk, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_aclk : signal is "xilinx.com:signal:clock:1.0 S_AXI_SIGDELAY_aclk CLK";
  attribute X_INTERFACE_PARAMETER of S_AXI_SIGDELAY_aclk : signal is "XIL_INTERFACENAME S_AXI_SIGDELAY_aclk, ASSOCIATED_BUSIF S_AXI_SIGDELAY, ASSOCIATED_RESET S_AXI_SIGDELAY_aresetn, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN InnerProbe_clk_wiz_0_0_system_clk, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_aresetn : signal is "xilinx.com:signal:reset:1.0 S_AXI_SIGDELAY_aresetn RST";
  attribute X_INTERFACE_PARAMETER of S_AXI_SIGDELAY_aresetn : signal is "XIL_INTERFACENAME S_AXI_SIGDELAY_aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_arready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY ARREADY";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_arvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY ARVALID";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_awready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY AWREADY";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_awvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY AWVALID";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_bready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY BREADY";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_bvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY BVALID";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_rready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY RREADY";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_rvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY RVALID";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_wready : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY WREADY";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_wvalid : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY WVALID";
  attribute X_INTERFACE_INFO of rst_n : signal is "xilinx.com:signal:reset:1.0 rst_n RST";
  attribute X_INTERFACE_PARAMETER of rst_n : signal is "XIL_INTERFACENAME rst_n, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_araddr : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY ARADDR";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_arprot : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY ARPROT";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_awaddr : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY AWADDR";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_awprot : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY AWPROT";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_bresp : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY BRESP";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_rdata : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY RDATA";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_rresp : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY RRESP";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_wdata : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY WDATA";
  attribute X_INTERFACE_INFO of S_AXI_SIGDELAY_wstrb : signal is "xilinx.com:interface:aximm:1.0 S_AXI_SIGDELAY WSTRB";
  attribute X_INTERFACE_PARAMETER of S_AXI_SIGDELAY_wstrb : signal is "XIL_INTERFACENAME S_AXI_SIGDELAY, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 100000000, ID_WIDTH 0, ADDR_WIDTH 4, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.0, CLK_DOMAIN InnerProbe_clk_wiz_0_0_system_clk, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
begin
  S_AXI_SIGDELAY_bresp(1) <= \<const0>\;
  S_AXI_SIGDELAY_bresp(0) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(31) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(30) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(29) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(28) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(27) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(26) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(25) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(24) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(23) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(22) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(21) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(20) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(19) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(18) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(17) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(16) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(15) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(14) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(13) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(12) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(11) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(10) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(9) <= \<const0>\;
  S_AXI_SIGDELAY_rdata(8 downto 0) <= \^s_axi_sigdelay_rdata\(8 downto 0);
  S_AXI_SIGDELAY_rresp(1) <= \<const0>\;
  S_AXI_SIGDELAY_rresp(0) <= \<const0>\;
GND: unisim.vcomponents.GND
     port map (
      G => \<const0>\
    );
inst: entity work.InnerProbe_AXI_Signal_Delay_0_0_AXI_Signal_Delay
     port map (
      IDELAYCTRL_RST => IDELAYCTRL_RST,
      REFCLK => REFCLK,
      S_AXI_SIGDELAY_aclk => S_AXI_SIGDELAY_aclk,
      S_AXI_SIGDELAY_araddr(1 downto 0) => S_AXI_SIGDELAY_araddr(3 downto 2),
      S_AXI_SIGDELAY_aresetn => S_AXI_SIGDELAY_aresetn,
      S_AXI_SIGDELAY_arready => S_AXI_SIGDELAY_arready,
      S_AXI_SIGDELAY_arvalid => S_AXI_SIGDELAY_arvalid,
      S_AXI_SIGDELAY_awaddr(1 downto 0) => S_AXI_SIGDELAY_awaddr(3 downto 2),
      S_AXI_SIGDELAY_awready => S_AXI_SIGDELAY_awready,
      S_AXI_SIGDELAY_awvalid => S_AXI_SIGDELAY_awvalid,
      S_AXI_SIGDELAY_bready => S_AXI_SIGDELAY_bready,
      S_AXI_SIGDELAY_bvalid => S_AXI_SIGDELAY_bvalid,
