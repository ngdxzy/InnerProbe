...
--               d:/vivado/ZCU104/InnerProbe/Scripts/InnerProbe/InnerProbe.srcs/sources_1/bd/InnerProbe/ip/InnerProbe_clk_wiz_0_0/InnerProbe_clk_wiz_0_0_sim_netlist.vhdl
...
entity InnerProbe_clk_wiz_0_0_InnerProbe_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of InnerProbe_clk_wiz_0_0_InnerProbe_clk_wiz_0_0_clk_wiz : entity is "InnerProbe_clk_wiz_0_0_clk_wiz";
end InnerProbe_clk_wiz_0_0_InnerProbe_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of InnerProbe_clk_wiz_0_0_InnerProbe_clk_wiz_0_0_clk_wiz is
  signal clk_in1_InnerProbe_clk_wiz_0_0 : STD_LOGIC;
  signal refclk_InnerProbe_clk_wiz_0_0 : STD_LOGIC;
  signal reset_high : STD_LOGIC;
  signal system_clk_InnerProbe_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_InnerProbe_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => system_clk_InnerProbe_clk_wiz_0_0,
      O => system_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => refclk_InnerProbe_clk_wiz_0_0,
      O => refclk
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_InnerProbe_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => system_clk_InnerProbe_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => refclk_InnerProbe_clk_wiz_0_0,
...
entity InnerProbe_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of InnerProbe_clk_wiz_0_0 : entity is true;
end InnerProbe_clk_wiz_0_0;

architecture STRUCTURE of InnerProbe_clk_wiz_0_0 is
begin
inst: entity work.InnerProbe_clk_wiz_0_0_InnerProbe_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      locked => locked,
      refclk => refclk,
