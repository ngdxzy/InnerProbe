...
add_cells_to_pblock [get_pblocks pblock_SRC_reg_0] [get_cells -quiet [list InnerProbe_i/SRC_reg_1]]
resize_pblock [get_pblocks pblock_SRC_reg_0] -add {SLICE_X1Y340:SLICE_X2Y340}
...
add_cells_to_pblock [get_pblocks pblock_dst_reg_reg] [get_cells -quiet [list InnerProbe_i/DST_sys/AXI_ProbeDetector_1/inst/dst_reg_reg InnerProbe_i/DST_sys/AXI_ProbeDetector_1/inst/ff_metastable_reg]]
resize_pblock [get_pblocks pblock_dst_reg_reg] -add {SLICE_X1Y347:SLICE_X2Y348}


create_pblock pblock_CapLoad
add_cells_to_pblock [get_pblocks pblock_CapLoad] [get_cells -quiet [list InnerProbe_i/CapLoad]]
resize_pblock [get_pblocks pblock_CapLoad] -add {SLICE_X1Y357:SLICE_X2Y358}
